...
const AddTagDialog = ({ addTagHandler }: {
  ...
  const { reset, control, handleSubmit, setError, formState: { errors } } = useForm<Tag>({
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button variant="link" className="cursor-pointer text-center text-blue-500 block flex justify-center items-center w-full">Add tags</Button>
      </DialogTrigger>
      <DialogContent>
        <div onSubmit={(e) => { e.preventDefault(); e.stopPropagation(); }}>
